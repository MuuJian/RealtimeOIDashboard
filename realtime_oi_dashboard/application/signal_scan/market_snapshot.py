"""Load market snapshots for signal scanning."""
...
class SignalScanMarketSnapshotLoader:
    ...
    def __init__(
        ...
        *,
        ...
        self._market_data = resolve_market_data_source(
            market_data=market_data,
            legacy_shared_cache=shared_rest_cache,
            direct_factory=lambda: DirectBinanceMarketData(
                request_json,
                ticker_attempts=SIGNAL_SCAN_HTTP_ATTEMPTS,
                exchange_info_attempts=SIGNAL_SCAN_HTTP_ATTEMPTS,
            ),
        )
    ...
    def load(self) -> tuple[list, dict]:
        ...
        tickers = self._market_data.get_tickers()
    ...
    def load_exchange_info(self) -> dict:
        ...
        with self._refresh_lock:
            ...
            exchange_info = self._market_data.get_exchange_info()
