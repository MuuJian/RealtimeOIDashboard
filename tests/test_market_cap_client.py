...
from realtime_oi_dashboard.infrastructure.coingecko.client import CoinGeckoMarketCapClient
...
class CoinGeckoMarketCapClientTests(unittest.TestCase):
    ...
    def test_successful_page_merges_without_clearing_old_values(self):
        ...
        with patch(
            "realtime_oi_dashboard.infrastructure.coingecko.client.time.time",
            return_value=20.0,
        ):
    ...
    def test_background_round_spaces_pages_and_stops_cleanly(self):
        ...
        with (
            patch(
                "realtime_oi_dashboard.infrastructure.coingecko.client.COINGECKO_PAGE_COUNT",
                2,
            ),
            patch(
                "realtime_oi_dashboard.infrastructure.coingecko.client.time.monotonic",
